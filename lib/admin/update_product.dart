...
class Update_Product extends StatefulWidget {
  ...
  Update_Product({required this.product});
  @override
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      final request = http.MultipartRequest(
          'POST', Uri.parse('http://127.0.0.1:8000/api/products/${id}'));
      ...
      request.fields['catigory'] = (_selectedCategory!.isNotEmpty ?_selectedCategory: widget.product.category)!;
      ...
      if (response.statusCode == 200) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
              ...
              content: Text('Error update product .')),
        );
      }
    }
  }
